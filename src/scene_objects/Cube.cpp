...
std::shared_ptr<VertexData> Cube::getTexturedVertexData()
{
    if (!s_texturedVertexData) {
        s_texturedVertexData = std::make_shared<VertexData>(CUBE_VERTICES_TEXTURED, sizeof(CUBE_VERTICES_TEXTURED), true);
    }
...
std::shared_ptr<VertexData> Cube::getUntexturedVertexData()
{
    if (!s_untexturedVertexData) {
        s_untexturedVertexData = std::make_shared<VertexData>(CUBE_VERTICES_UNTEXTURED, sizeof(CUBE_VERTICES_UNTEXTURED), false);
    }
